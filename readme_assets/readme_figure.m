...
% Name:         readme_figure.m
%
% Description:
%   Produces the plots shown in Figure 1 of the README. 
...
subplot(1,2,1);
bihist(d1, d2, 0.01, [])
title('Bihistogram with raw data');
xlabel('production time (seconds)');

subplot(1,2,2);
bihist(d1, d2, 0.01, [100, 1000])
title('Bihistogram with bootstrapped data');
ylim([-0.4 0.4])
xlim([105.9 106.05])
xlabel('production time (seconds)');